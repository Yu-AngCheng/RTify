...
# Note that a similar implementation can be found in AlexNet_BN_LSTM_backbone.py
# The only difference is this version only uses the outputs of the decision time point
# For replicating the results in SI, use this implementation
# But for replicating the results in main text, use AlexNet_BN_LSTM_backbone.py
...
if __name__ == '__main__':
    ...
    train_model(model, criterion, optimizer, num_epochs=200, model_name='AlexNet_BN_LSTM_norm_2', lr_scheduler=lr_scheduler, norm=True, curiculum=True)
