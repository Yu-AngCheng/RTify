"""
This file is an exact copy of the original losses.py file from the original repository. It contains the implementation of the
EDL loss function. The original file can be found here: https://github.com/serre-lab/rnn_rts/blob/main/utils/loss.py

These are the bibliographical details of the original paper:
Goetschalckx, L., Govindarajan, L. N., Karkada Ashok, A., Ahuja, A., Sheinberg, D., & Serre, T. (2024).
